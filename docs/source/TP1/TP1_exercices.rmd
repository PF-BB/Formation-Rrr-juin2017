...
3. Créer le vecteur `vec3` contenant une fois le chiffre 1, deux fois le chiffre 2, trois fois le chiffre 3 ... et 20 fois le chiffre 20. Quelle est la longueur de cette suite ? *Indice: `length()`*
